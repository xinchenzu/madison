...
Output: JSON-compatible result written to logs/social-media-marketing-rss-monitor-prepare-social-media-marketing-feed-export.json when --output is supplied.
...
Recipe: recipes/social-media-marketing-rss-monitor.md
"""
...
WORKFLOW_NAME = 'Social Media Marketing RSS Monitor'
WORKFLOW_SLUG = 'social-media-marketing-rss-monitor'
NODE_NAME = 'Prepare social-media marketing feed export'
NODE_TYPE = 'n8n-nodes-base.convertToFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/social-media-marketing-rss-monitor-prepare-social-media-marketing-feed-export.json'
...
def prepare_social_media_marketing_feed_export(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local output contract, export handoff, or analysis result for this converted n8n output node.
...
if __name__ == "__main__":
    ...
    write_json(prepare_social_media_marketing_feed_export(payload["data"]), payload["output"])
