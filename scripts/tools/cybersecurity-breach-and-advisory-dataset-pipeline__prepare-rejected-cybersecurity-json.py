...
Output: JSON-compatible result written to logs/cybersecurity-breach-and-advisory-dataset-pipeline-prepare-rejected-cybersecurity-json.json when --output is supplied.
...
NODE_NAME = 'Prepare rejected cybersecurity JSON'
NODE_TYPE = 'n8n-nodes-base.convertToFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/cybersecurity-breach-and-advisory-dataset-pipeline-prepare-rejected-cybersecurity-json.json'
...
def prepare_rejected_cybersecurity_json(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local output contract, export handoff, or analysis result for this converted n8n output node.
...
if __name__ == "__main__":
    ...
    write_json(prepare_rejected_cybersecurity_json(payload["data"]), payload["output"])
