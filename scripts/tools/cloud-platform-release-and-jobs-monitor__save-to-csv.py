...
Output: JSON-compatible result written to logs/cloud-platform-release-and-jobs-monitor-save-to-csv.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/cloud-platform-release-and-jobs-monitor-save-to-csv.json'
