...
Output: JSON-compatible result written to logs/data-center-hiring-signal-monitor-prepare-data-center-hiring-signal-export.json when --output is supplied.
...
NODE_NAME = 'Prepare data-center hiring signal export'
NODE_TYPE = 'n8n-nodes-base.convertToFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/data-center-hiring-signal-monitor-prepare-data-center-hiring-signal-export.json'
...
def prepare_data_center_hiring_signal_export(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local output contract, export handoff, or analysis result for this converted n8n output node.
...
if __name__ == "__main__":
    ...
    write_json(prepare_data_center_hiring_signal_export(payload["data"]), payload["output"])
