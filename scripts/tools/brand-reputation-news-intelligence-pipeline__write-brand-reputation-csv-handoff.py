...
Output: JSON-compatible result written to logs/brand-reputation-news-intelligence-pipeline-write-brand-reputation-csv-handoff.json when --output is supplied.
...
NODE_NAME = 'Write brand-reputation CSV handoff'
NODE_TYPE = 'n8n-nodes-base.readWriteFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/brand-reputation-news-intelligence-pipeline-write-brand-reputation-csv-handoff.json'
...
def write_brand_reputation_csv_handoff(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local output contract, export handoff, or analysis result for this converted n8n output node.
...
if __name__ == "__main__":
    ...
    write_json(write_brand_reputation_csv_handoff(payload["data"]), payload["output"])
