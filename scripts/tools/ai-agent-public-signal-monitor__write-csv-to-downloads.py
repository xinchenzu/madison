...
Output: JSON-compatible result written to logs/ai-agent-public-signal-monitor-write-csv-to-downloads.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/ai-agent-public-signal-monitor-write-csv-to-downloads.json'
