...
Output: JSON-compatible result written to logs/cybersecurity-breach-and-advisory-dataset-pipeline-prepare-normalized-breach-json.json when --output is supplied.
...
NODE_NAME = 'Prepare normalized breach JSON'
NODE_TYPE = 'n8n-nodes-base.convertToFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/cybersecurity-breach-and-advisory-dataset-pipeline-prepare-normalized-breach-json.json'
...
def prepare_normalized_breach_json(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local output contract, export handoff, or analysis result for this converted n8n output node.
...
if __name__ == "__main__":
    ...
    write_json(prepare_normalized_breach_json(payload["data"]), payload["output"])
