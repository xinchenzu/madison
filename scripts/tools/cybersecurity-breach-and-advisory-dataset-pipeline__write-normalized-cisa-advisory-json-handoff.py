...
Output: JSON-compatible result written to logs/cybersecurity-breach-and-advisory-dataset-pipeline-write-normalized-cisa-advisory-json-handoff.json when --output is supplied.
...
NODE_NAME = 'Write normalized CISA advisory JSON handoff'
NODE_TYPE = 'n8n-nodes-base.readWriteFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/cybersecurity-breach-and-advisory-dataset-pipeline-write-normalized-cisa-advisory-json-handoff.json'
...
def write_normalized_cisa_advisory_json_handoff(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local output contract, export handoff, or analysis result for this converted n8n output node.
...
if __name__ == "__main__":
    ...
    write_json(write_normalized_cisa_advisory_json_handoff(payload["data"]), payload["output"])
