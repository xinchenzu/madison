...
Output: JSON-compatible result written to logs/brand-reputation-news-intelligence-pipeline-norm-the-verge.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/brand-reputation-news-intelligence-pipeline-norm-the-verge.json'
