...
Output: JSON-compatible result written to logs/cybersecurity-breach-and-advisory-dataset-pipeline-write-clean-cybersecurity-json-handoff.json when --output is supplied.
...
NODE_NAME = 'Write clean cybersecurity JSON handoff'
NODE_TYPE = 'n8n-nodes-base.readWriteFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/cybersecurity-breach-and-advisory-dataset-pipeline-write-clean-cybersecurity-json-handoff.json'
...
def write_clean_cybersecurity_json_handoff(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local output contract, export handoff, or analysis result for this converted n8n output node.
...
if __name__ == "__main__":
    ...
    write_json(write_clean_cybersecurity_json_handoff(payload["data"]), payload["output"])
