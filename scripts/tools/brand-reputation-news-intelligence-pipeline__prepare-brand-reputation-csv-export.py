...
Output: JSON-compatible result written to logs/brand-reputation-news-intelligence-pipeline-prepare-brand-reputation-csv-export.json when --output is supplied.
...
Recipe: recipes/brand-reputation-news-intelligence-pipeline.md
"""
...
WORKFLOW_NAME = 'Brand Reputation News Intelligence Pipeline'
WORKFLOW_SLUG = 'brand-reputation-news-intelligence-pipeline'
NODE_NAME = 'Prepare brand-reputation CSV export'
NODE_TYPE = 'n8n-nodes-base.convertToFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/brand-reputation-news-intelligence-pipeline-prepare-brand-reputation-csv-export.json'
...
def prepare_brand_reputation_csv_export(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local output contract, export handoff, or analysis result for this converted n8n output node.
...
if __name__ == "__main__":
    ...
    write_json(prepare_brand_reputation_csv_export(payload["data"]), payload["output"])
