...
Output: JSON-compatible result written to logs/accessibility-standards-and-rules-monitor-save-to-csv.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/accessibility-standards-and-rules-monitor-save-to-csv.json'
