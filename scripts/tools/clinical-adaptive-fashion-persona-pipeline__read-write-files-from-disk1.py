...
Output: JSON-compatible result written to logs/clinical-adaptive-fashion-persona-pipeline-read-write-files-from-disk1.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/clinical-adaptive-fashion-persona-pipeline-read-write-files-from-disk1.json'
