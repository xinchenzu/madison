...
Output: JSON-compatible result written to logs/ai-agent-public-signal-monitor-convert-to-csv.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/ai-agent-public-signal-monitor-convert-to-csv.json'
