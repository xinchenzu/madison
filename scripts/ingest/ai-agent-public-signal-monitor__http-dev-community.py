...
Output: JSON-compatible result written to data/raw/ai-agent-public-signal-monitor/http-dev-community.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/ai-agent-public-signal-monitor/http-dev-community.json'
