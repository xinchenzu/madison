...
Output: JSON-compatible result written to data/raw/brand-reputation-news-intelligence-pipeline/rss-the-verge.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/brand-reputation-news-intelligence-pipeline/rss-the-verge.json'
