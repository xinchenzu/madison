...
Output: JSON-compatible result written to data/raw/social-media-marketing-rss-monitor/fetch-hootsuite-blog-rss.json when --output is supplied.
...
NODE_NAME = 'Fetch Hootsuite blog RSS'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/social-media-marketing-rss-monitor/fetch-hootsuite-blog-rss.json'
...
def fetch_hootsuite_blog_rss(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n source node.
...
if __name__ == "__main__":
    ...
    write_json(fetch_hootsuite_blog_rss(payload["data"]), payload["output"])
