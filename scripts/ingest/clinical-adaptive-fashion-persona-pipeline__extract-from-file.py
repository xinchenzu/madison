...
Output: JSON-compatible result written to data/raw/clinical-adaptive-fashion-persona-pipeline/extract-from-file.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/clinical-adaptive-fashion-persona-pipeline/extract-from-file.json'
