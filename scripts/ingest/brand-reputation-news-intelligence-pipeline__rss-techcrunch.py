...
Output: JSON-compatible result written to data/raw/brand-reputation-news-intelligence-pipeline/rss-techcrunch.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/brand-reputation-news-intelligence-pipeline/rss-techcrunch.json'
