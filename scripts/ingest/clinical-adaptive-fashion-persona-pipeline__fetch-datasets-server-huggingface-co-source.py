...
Output: JSON-compatible result written to data/raw/clinical-adaptive-fashion-persona-pipeline/fetch-datasets-server-huggingface-co-source.json when --output is supplied.
...
Recipe: recipes/clinical-adaptive-fashion-persona-pipeline.md
"""
...
WORKFLOW_NAME = 'Clinical Adaptive Fashion Persona Pipeline'
WORKFLOW_SLUG = 'clinical-adaptive-fashion-persona-pipeline'
NODE_NAME = 'Fetch datasets-server.huggingface.co source'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/clinical-adaptive-fashion-persona-pipeline/fetch-datasets-server-huggingface-co-source.json'
...
def fetch_datasets_server_huggingface_co_source(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n source node.
...
if __name__ == "__main__":
    ...
    write_json(fetch_datasets_server_huggingface_co_source(payload["data"]), payload["output"])
