...
Output: JSON-compatible result written to data/raw/social-media-marketing-rss-monitor/fetch-hubspot-marketing-rss.json when --output is supplied.
...
NODE_NAME = 'Fetch HubSpot marketing RSS'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/social-media-marketing-rss-monitor/fetch-hubspot-marketing-rss.json'
...
def fetch_hubspot_marketing_rss(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n source node.
...
if __name__ == "__main__":
    ...
    write_json(fetch_hubspot_marketing_rss(payload["data"]), payload["output"])
