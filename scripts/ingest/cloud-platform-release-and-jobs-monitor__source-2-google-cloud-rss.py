...
Output: JSON-compatible result written to data/raw/cloud-platform-release-and-jobs-monitor/source-2-google-cloud-rss.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/cloud-platform-release-and-jobs-monitor/source-2-google-cloud-rss.json'
