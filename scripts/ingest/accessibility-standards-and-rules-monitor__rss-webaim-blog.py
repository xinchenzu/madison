...
Output: JSON-compatible result written to data/raw/accessibility-standards-and-rules-monitor/rss-webaim-blog.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/accessibility-standards-and-rules-monitor/rss-webaim-blog.json'
