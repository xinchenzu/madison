...
Output: JSON-compatible result written to data/raw/social-media-marketing-rss-monitor/fetch-sprout-social-insights-rss.json when --output is supplied.
...
NODE_NAME = 'Fetch Sprout Social insights RSS'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/social-media-marketing-rss-monitor/fetch-sprout-social-insights-rss.json'
...
def fetch_sprout_social_insights_rss(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n source node.
...
if __name__ == "__main__":
    ...
    write_json(fetch_sprout_social_insights_rss(payload["data"]), payload["output"])
