...
Output: JSON-compatible result written to data/raw/cloud-platform-release-and-jobs-monitor/source-3-cloud-jobs-csv-http.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/cloud-platform-release-and-jobs-monitor/source-3-cloud-jobs-csv-http.json'
