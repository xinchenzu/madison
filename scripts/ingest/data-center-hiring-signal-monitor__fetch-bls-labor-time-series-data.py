...
Output: JSON-compatible result written to data/raw/data-center-hiring-signal-monitor/fetch-bls-labor-time-series-data.json when --output is supplied.
...
NODE_NAME = 'Fetch BLS labor time-series data'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/data-center-hiring-signal-monitor/fetch-bls-labor-time-series-data.json'
...
def fetch_bls_labor_time_series_data(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n source node.
...
if __name__ == "__main__":
    ...
    write_json(fetch_bls_labor_time_series_data(payload["data"]), payload["output"])
