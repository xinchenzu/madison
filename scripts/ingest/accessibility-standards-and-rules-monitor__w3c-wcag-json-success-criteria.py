...
Output: JSON-compatible result written to data/raw/accessibility-standards-and-rules-monitor/w3c-wcag-json-success-criteria.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/accessibility-standards-and-rules-monitor/w3c-wcag-json-success-criteria.json'
