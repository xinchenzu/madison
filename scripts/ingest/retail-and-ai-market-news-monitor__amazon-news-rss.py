...
Output: JSON-compatible result written to data/raw/retail-and-ai-market-news-monitor/amazon-news-rss.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/retail-and-ai-market-news-monitor/amazon-news-rss.json'
