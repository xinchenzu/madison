...
Output: JSON-compatible result written to data/raw/clinical-adaptive-fashion-persona-pipeline/read-write-files-from-disk.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/clinical-adaptive-fashion-persona-pipeline/read-write-files-from-disk.json'
