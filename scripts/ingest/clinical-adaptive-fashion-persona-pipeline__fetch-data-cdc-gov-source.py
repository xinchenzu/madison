...
Output: JSON-compatible result written to data/raw/clinical-adaptive-fashion-persona-pipeline/fetch-data-cdc-gov-source.json when --output is supplied.
...
NODE_NAME = 'Fetch data.cdc.gov source'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/clinical-adaptive-fashion-persona-pipeline/fetch-data-cdc-gov-source.json'
...
def fetch_data_cdc_gov_source(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n source node.
...
if __name__ == "__main__":
    ...
    write_json(fetch_data_cdc_gov_source(payload["data"]), payload["output"])
