...
Output: JSON-compatible result written to data/raw/brand-reputation-news-intelligence-pipeline/fetch-newsapi-brand-reputation-articles.json when --output is supplied.
...
NODE_NAME = 'Fetch NewsAPI brand-reputation articles'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/brand-reputation-news-intelligence-pipeline/fetch-newsapi-brand-reputation-articles.json'
...
def fetch_newsapi_brand_reputation_articles(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n source node.
...
if __name__ == "__main__":
    ...
    write_json(fetch_newsapi_brand_reputation_articles(payload["data"]), payload["output"])
