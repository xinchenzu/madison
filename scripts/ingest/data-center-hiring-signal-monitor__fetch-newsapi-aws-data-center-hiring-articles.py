...
Output: JSON-compatible result written to data/raw/data-center-hiring-signal-monitor/fetch-newsapi-aws-data-center-hiring-articles.json when --output is supplied.
...
NODE_NAME = 'Fetch NewsAPI AWS data-center hiring articles'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/data-center-hiring-signal-monitor/fetch-newsapi-aws-data-center-hiring-articles.json'
...
def fetch_newsapi_aws_data_center_hiring_articles(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n source node.
...
if __name__ == "__main__":
    ...
    write_json(fetch_newsapi_aws_data_center_hiring_articles(payload["data"]), payload["output"])
