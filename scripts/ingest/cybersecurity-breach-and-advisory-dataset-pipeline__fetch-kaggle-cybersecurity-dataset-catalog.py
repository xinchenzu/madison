...
Output: JSON-compatible result written to data/raw/cybersecurity-breach-and-advisory-dataset-pipeline/fetch-kaggle-cybersecurity-dataset-catalog.json when --output is supplied.
...
NODE_NAME = 'Fetch Kaggle cybersecurity dataset catalog'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/cybersecurity-breach-and-advisory-dataset-pipeline/fetch-kaggle-cybersecurity-dataset-catalog.json'
...
def fetch_kaggle_cybersecurity_dataset_catalog(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n source node.
...
if __name__ == "__main__":
    ...
    write_json(fetch_kaggle_cybersecurity_dataset_catalog(payload["data"]), payload["output"])
