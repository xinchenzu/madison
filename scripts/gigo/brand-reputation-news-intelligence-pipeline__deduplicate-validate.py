...
Output: JSON-compatible result written to data/verified/brand-reputation-news-intelligence-pipeline/deduplicate-validate.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/brand-reputation-news-intelligence-pipeline/deduplicate-validate.json'
...
def deduplicate_validate(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, deduplicate, or quality-check records for this converted n8n processing node.
...
if __name__ == "__main__":
    ...
    write_json(deduplicate_validate(payload["data"]), payload["output"])
