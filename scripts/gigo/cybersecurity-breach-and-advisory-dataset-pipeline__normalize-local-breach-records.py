...
Output: JSON-compatible result written to data/verified/cybersecurity-breach-and-advisory-dataset-pipeline/normalize-local-breach-records.json when --output is supplied.
...
NODE_NAME = 'Normalize local breach records'
NODE_TYPE = 'n8n-nodes-base.code'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/cybersecurity-breach-and-advisory-dataset-pipeline/normalize-local-breach-records.json'
...
def normalize_local_breach_records(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, deduplicate, or quality-check records for this converted n8n processing node.
...
if __name__ == "__main__":
    ...
    write_json(normalize_local_breach_records(payload["data"]), payload["output"])
