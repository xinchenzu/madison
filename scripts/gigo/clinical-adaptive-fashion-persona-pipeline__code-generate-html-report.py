...
Output: JSON-compatible result written to data/verified/clinical-adaptive-fashion-persona-pipeline/code-generate-html-report.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/clinical-adaptive-fashion-persona-pipeline/code-generate-html-report.json'
