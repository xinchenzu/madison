...
Output: JSON-compatible result written to data/verified/accessibility-standards-and-rules-monitor/write-error-log.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/accessibility-standards-and-rules-monitor/write-error-log.json'
