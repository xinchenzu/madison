...
Output: JSON-compatible result written to data/verified/ai-agent-public-signal-monitor/normalize-github.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/ai-agent-public-signal-monitor/normalize-github.json'
