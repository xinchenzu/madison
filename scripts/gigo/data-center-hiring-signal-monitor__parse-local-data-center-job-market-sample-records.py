...
Output: JSON-compatible result written to data/verified/data-center-hiring-signal-monitor/parse-local-data-center-job-market-sample-records.json when --output is supplied.
...
Recipe: recipes/data-center-hiring-signal-monitor.md
"""
...
WORKFLOW_NAME = 'Data Center Hiring Signal Monitor'
WORKFLOW_SLUG = 'data-center-hiring-signal-monitor'
NODE_NAME = 'Parse local data-center job-market sample records'
NODE_TYPE = 'n8n-nodes-base.code'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/data-center-hiring-signal-monitor/parse-local-data-center-job-market-sample-records.json'
...
def parse_local_data_center_job_market_sample_records(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, deduplicate, or quality-check records for this converted n8n processing node.
...
if __name__ == "__main__":
    ...
    write_json(parse_local_data_center_job_market_sample_records(payload["data"]), payload["output"])
