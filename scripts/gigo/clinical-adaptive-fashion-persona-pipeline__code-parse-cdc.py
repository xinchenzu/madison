...
Output: JSON-compatible result written to data/verified/clinical-adaptive-fashion-persona-pipeline/code-parse-cdc.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/clinical-adaptive-fashion-persona-pipeline/code-parse-cdc.json'
