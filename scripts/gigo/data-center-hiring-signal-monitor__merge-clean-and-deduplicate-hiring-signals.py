...
Output: JSON-compatible result written to data/verified/data-center-hiring-signal-monitor/merge-clean-and-deduplicate-hiring-signals.json when --output is supplied.
...
NODE_NAME = 'Merge, clean, and deduplicate hiring signals'
NODE_TYPE = 'n8n-nodes-base.code'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/data-center-hiring-signal-monitor/merge-clean-and-deduplicate-hiring-signals.json'
...
def merge_clean_and_deduplicate_hiring_signals(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, deduplicate, or quality-check records for this converted n8n processing node.
...
if __name__ == "__main__":
    ...
    write_json(merge_clean_and_deduplicate_hiring_signals(payload["data"]), payload["output"])
