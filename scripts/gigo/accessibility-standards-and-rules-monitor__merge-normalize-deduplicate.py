...
Output: JSON-compatible result written to data/verified/accessibility-standards-and-rules-monitor/merge-normalize-deduplicate.json when --output is supplied.
...
Recipe: recipes/accessibility-standards-and-rules-monitor.md
"""
...
WORKFLOW_NAME = 'Accessibility Standards And Rules Monitor'
WORKFLOW_SLUG = 'accessibility-standards-and-rules-monitor'
NODE_NAME = 'Merge + Normalize + Deduplicate'
NODE_TYPE = 'n8n-nodes-base.code'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/accessibility-standards-and-rules-monitor/merge-normalize-deduplicate.json'
