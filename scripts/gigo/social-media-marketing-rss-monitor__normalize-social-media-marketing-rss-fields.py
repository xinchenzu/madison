...
Output: JSON-compatible result written to data/verified/social-media-marketing-rss-monitor/normalize-social-media-marketing-rss-fields.json when --output is supplied.
...
NODE_NAME = 'Normalize social-media marketing RSS fields'
NODE_TYPE = 'n8n-nodes-base.set'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/social-media-marketing-rss-monitor/normalize-social-media-marketing-rss-fields.json'
...
def normalize_social_media_marketing_rss_fields(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, deduplicate, or quality-check records for this converted n8n processing node.
...
if __name__ == "__main__":
    ...
    write_json(normalize_social_media_marketing_rss_fields(payload["data"]), payload["output"])
