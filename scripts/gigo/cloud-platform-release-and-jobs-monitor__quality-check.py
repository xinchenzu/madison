...
Output: JSON-compatible result written to data/verified/cloud-platform-release-and-jobs-monitor/quality-check.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/cloud-platform-release-and-jobs-monitor/quality-check.json'
