...
Output: JSON-compatible result written to data/verified/brand-reputation-news-intelligence-pipeline/norm-huggingface.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/brand-reputation-news-intelligence-pipeline/norm-huggingface.json'
