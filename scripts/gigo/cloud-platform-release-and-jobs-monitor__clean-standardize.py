...
Output: JSON-compatible result written to data/verified/cloud-platform-release-and-jobs-monitor/clean-standardize.json when --output is supplied.
...
Recipe: recipes/cloud-platform-release-and-jobs-monitor.md
"""
...
WORKFLOW_NAME = 'Cloud Platform Release And Jobs Monitor'
WORKFLOW_SLUG = 'cloud-platform-release-and-jobs-monitor'
NODE_NAME = 'Clean & Standardize'
NODE_TYPE = 'n8n-nodes-base.code'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/cloud-platform-release-and-jobs-monitor/clean-standardize.json'
...
def clean_standardize(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, deduplicate, or quality-check records for this converted n8n processing node.
...
if __name__ == "__main__":
    ...
    write_json(clean_standardize(payload["data"]), payload["output"])
