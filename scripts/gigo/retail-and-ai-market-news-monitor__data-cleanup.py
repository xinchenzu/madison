...
Output: JSON-compatible result written to data/verified/retail-and-ai-market-news-monitor/data-cleanup.json when --output is supplied.
...
Recipe: recipes/retail-and-ai-market-news-monitor.md
"""
...
WORKFLOW_NAME = 'Retail And AI Market News Monitor'
WORKFLOW_SLUG = 'retail-and-ai-market-news-monitor'
NODE_NAME = 'Data Cleanup'
NODE_TYPE = 'n8n-nodes-base.set'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/retail-and-ai-market-news-monitor/data-cleanup.json'
