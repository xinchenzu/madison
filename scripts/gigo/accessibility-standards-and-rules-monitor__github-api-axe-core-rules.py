...
Output: JSON-compatible result written to data/verified/accessibility-standards-and-rules-monitor/github-api-axe-core-rules.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/accessibility-standards-and-rules-monitor/github-api-axe-core-rules.json'
