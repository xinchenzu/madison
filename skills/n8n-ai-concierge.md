# Skill: n8n AI Concierge

## Executive Summary

This skill is an agent-readable conversion of an imported n8n workflow. The
original workflow JSON is preserved at `data/madison-main/n8n-workflows/originals/Archives/Cicerone/AI Concierge.json`. Use this skill to understand
...
- **Source file:** `data/madison-main/n8n-workflows/originals/Archives/Cicerone/AI Concierge.json`
- **Workflow name:** AI Concierge
- **Node count:** 7
- **Detected triggers:** When chat message received
...
| Get Inventory | `n8n-nodes-base.googleSheetsTool` |
| Get FAQ | `n8n-nodes-base.googleSheetsTool` |
| Orders | `n8n-nodes-base.googleSheetsTool` |
