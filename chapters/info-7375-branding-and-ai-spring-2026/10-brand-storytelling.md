...
![A side-by-side comparison of the brand-as-hero framing vs. the customer-as-hero framing — same product, two story shapes. Left: brand is...](images/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-01.png)
*Figure 0.1 — side-by-side comparison of the brand-as-hero framing vs*
...
![A reference table mapping the twelve archetypes to their native story shapes — columns: Archetype, Native Story Shape(s), Why the Shape...](images/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-02.png)
*Figure 0.2 — reference table mapping the twelve archetypes to their native story shapes*
...
| --- | --- | --- | --- | --- |
| Reference | Connects reference to the chapter's main distinction | Connects reference to the chapter's main distinction | Connects reference to the chapter's main distinction | Example: reference |
| Failure | Connects failure to the chapter's main distinction | Connects failure to the chapter's main distinction | Connects failure to the chapter's main distinction | Example: failure |
| Pathways | Connects pathways to the chapter's main distinction | Connects pathways to the chapter's main distinction | Connects pathways to the chapter's main distinction | Example: pathways |
...
![A breakdown diagram of the Pepsi ad's three-layer mismatch — three rows labeled "Story Shape Attempted," "Brand's Actual Archetype," and...](images/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-03.png)
*Figure 0.3 — breakdown diagram of the Pepsi ad's three-layer mismatch*
...
| --- | --- | --- | --- | --- | --- |
| Cross | Example: cross | Connects cross to the chapter's main distinction | Fails when cross is treated as settled instead of checked | Use cross as the decision guide | Use cross as the decision guide |
| Case | Example: case | Connects case to the chapter's main distinction | Fails when case is treated as settled instead of checked | Use case as the decision guide | Use case as the decision guide |
| Comparison | Example: comparison | Connects comparison to the chapter's main distinction | Fails when comparison is treated as settled instead of checked | Use comparison as the decision guide | Use comparison as the decision guide |
| Mismatch | Example: mismatch | Connects mismatch to the chapter's main distinction | Fails when mismatch is treated as settled instead of checked | Use mismatch as the decision guide | Use mismatch as the decision guide |
...
![A before/after comparison of the same case study written two ways — left: brand-as-hero with abstract stakes ("We built a tool that...](images/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-04.png)
*Figure 0.4 — before/after comparison of the same case study written two ways*
...
| --- | --- | --- | --- | --- |
| Reference | Connects reference to the chapter's main distinction | Connects reference to the chapter's main distinction | Example: reference | Fails when reference is treated as settled instead of checked |
| Story | Connects story to the chapter's main distinction | Connects story to the chapter's main distinction | Example: story | Fails when story is treated as settled instead of checked |
| Types | Connects types to the chapter's main distinction | Connects types to the chapter's main distinction | Example: types | Fails when types is treated as settled instead of checked |
| Type | Connects type to the chapter's main distinction | Connects type to the chapter's main distinction | Example: type | Fails when type is treated as settled instead of checked |
| Archetype | Connects archetype to the chapter's main distinction | Connects archetype to the chapter's main distinction | Example: archetype | Fails when archetype is treated as settled instead of checked |
...
![A matrix of story shapes × channels — rows: origin story, case study, quest story, thought-leadership, transformation story; columns:...](images/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-05.png)
*Figure 0.5 — matrix of story shapes × channels*
...
| Origin | Connects origin to the chapter's main distinction | Connects origin to the chapter's main distinction |
| Story | Connects story to the chapter's main distinction | Connects story to the chapter's main distinction |
| Scaffold | Connects scaffold to the chapter's main distinction | Connects scaffold to the chapter's main distinction |
...
![A visual template of the six case study elements arranged as a narrative arc — problem establishes stakes, "what they tried" creates the...](images/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-06.png)
*Figure 0.6 — visual template of the six case study elements arranged as a narrative arc*

---

## Cases from this edition: storytelling frameworks at work

Twenty-five cohort decks deployed at least one named narrative framework — the Hero's Journey carries the heaviest load (twelve cases use it directly), with Quest, Overcoming the Monster, Before / After / Because, and Problem-Agitate-Solve appearing across the rest. The cohort's strongest examples:

- **Chapter 21 (*Systems That Scale*, Gunashree Rajakumar)** deploys two frameworks for two complementary jobs — Hero's Journey for the visibility-transformation arc (*before branding: strong engineer, zero narrative; the course: INFO 7375 forced clarity; the build: portfolio, Substack, AI chatbot, brand defined; the result: brand with receipts*) and The Quest for the audience-targeting move (*right people started finding me; I wasn't explaining my background anymore; I was confirming what they already believed*). The two frames cover different terrain and together argue what *branding* did for an engineer whose work pre-existed the brand by five years.
- **Chapter 16 (*Production AI Specialist*, Swara Joshi)** deploys the Hero's Journey around a single defining metric (*150 seconds → 28 seconds, 81% reduction at Crossing*) and extracts a portable principle: *production AI is built on constraints, not capabilities*. The chapter's *story-shape carries archetypal commitment* argument is operative here — the Hero's Journey-with-extracted-principle frame matches the Sage-leaning brand voice precisely.
- **Chapter 19 (*MEDA*, Ananya Thathigowdara)** carries two complementary frameworks deliberately — Hero's Journey for the career-arc compression (*From Mumbai to Milliseconds*: chart-builder → pipeline-fixer → integrator) and Overcoming the Monster for the engineering-discipline argument (*reports that contradicted each other, dashboards built but never opened, executives deciding on gut feel because the numbers couldn't be trusted*). The two frames cover career narrative *and* engineering critique without forcing one frame to do both jobs.
- **Chapter 24 (*Claritix*, Ankit Deopurkar)** deploys Overcoming the Monster anchored on a specific incident (47 alerts, 4 real, 3 caught, 1 missed at $200K cost). The deck commits to a structural insight rather than a personal one: *the villain isn't a competitor — it's a systemic gap*. The Overcoming the Monster frame is doing the same architectural work for a Path B startup that it does for a Path A career narrative.
- **Chapter 36 (*AdverseAI*, Manisha Sahu)** deploys Quest framework with unusual specificity: *Spring 2020 — a public health project — three data sources — all disconnected — $50K tools or nothing*. The four-step Quest arc maps directly to the chapter's framework and produces a brand committed to *democratizing strategic intelligence* at a measurable per-query cost.
- **Chapter 37 (*Prismiq*, Ishaan Samel)** anchors origin on a specific lived family-business moment — *the $4 cable and the $1,500 bill*. The chapter's *audience-recognition* commitment is operationalized through specificity: a small-business owner reads the moment as recognition because the pattern (busy with daily operations, customer feedback unseen, slow erosion of trust) is the audience's own.
- **Chapter 35 (*SignalScout*, Aravind Ravi)** anchors the Hero's Journey on the Karpathy-tweet recognition (*I don't want to read Karpathy's read of the paper. I want to know if the paper is worth my read*) and closes on a philosophical commitment: *products that come from scar tissue feel inevitable. Not invented*. The story is calibrated for an audience that has lived the same six-hops-from-the-source frustration.

A cohort observation worth naming: every case in the case layer that landed cleanly on its archetype paired the storytelling frame to the archetype the chapter argues for. Sage-leaning brands deployed Hero's Journey with extracted principles; Creator-leaning brands deployed Overcoming the Monster with concrete incident-anchors; Quest framework appeared most often where the brand argued a category-creation move (AdverseAI's *democratizing* arc, Apexly's *fan-tool-to-B2B* arc, vigilixx's *building the layer that did not exist* arc). The story-shape carrying archetypal commitment is operative in the cohort exactly the way the chapter predicts.
...
Brand storytelling is one of the most over-templated genres in the book. The model has read every brand-storytelling framework ever published. The fluency hides the requirement that the story actually be your story.

Where the model genuinely helps: surfacing the canonical story structures — origin, transformation, mission, manifesto — and the moves each requires.

Where the model does damage: writing your brand's story. A story written by the model is structurally similar to your brand's story and emotionally different from it, in a way readers can feel without naming.

The rule: structure from the model; the story from you.
...
> Reference implementation: `d3/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-01.html`
...
> Reference implementation: `d3/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-02.html`
...
> Reference implementation: `d3/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-03.html`
...
> Reference implementation: `d3/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-04.html`
...
> Reference implementation: `d3/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-05.html`
...
> Reference implementation: `d3/info-7375-branding-and-ai-spring-2026-10-brand-storytelling-fig-06.html`
